...
<body>
	...
	<div class="container-fluid">
		<h3>Add a Hall</h3>
		<form:form action="/halls/new" method="post" modelAttribute="newHall">
			<div class="row my-4">
			...
			<input type="submit" class="btn btn-primary offset-2 col-2" value="Add hall">
		</form:form>
	</div>
</body>
</html>